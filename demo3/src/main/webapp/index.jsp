...
<body>
	<!-- 주소는 절대경로와 상대경로 설정할 수 있다. 
		 / <-- 절대 경로로 시작
			<-- 상대 경로로 시작
	-->
	<form action="/demo3/loginProc" method="post">
		<div class="form-group">
			<label for="email">Email Address : </label> <input type="email"  class="form-control"
				placeholder="Enter email" id="email" name="email" value="a@nate.com">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="isRemember" class="form-check-label">Remember me : </label> <input type="checkbox"
